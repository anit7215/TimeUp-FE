// src/pages/SelectWakeupAlarmVibratePage.tsx
...
export default function SelectWakeupAlarmVibratePage() {
  const navigation = useAppNavigation();
  const { selectedAlarmId, wakeupAlarms, updateWakeupAlarmField } = useAlarmContext();
  ...
  const handleConfirm = () => {
    if (selectedAlarmId && selectedVibration) {
      updateWakeupAlarmField(selectedAlarmId, 'vibrate', selectedVibration);

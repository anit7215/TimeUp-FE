...
const DayTimeModal = forwardRef<TimeModalRef, TimeModalProps>(
  ...
  >
    <BottomSheetView className='px-12 py-7 flex-1 justify-between items-center'>
      <View className="w-full items-center flex-grow justify-between">
        {choice === 'optional' && (
          <TouchableOpacity style={{ alignSelf: 'flex-end', marginRight: 16, marginBottom: 40 }} onPress={handleSelectLater}>
        ...
        <View style={{ flexGrow: 1, marginBottom: 64, }} /> 
      </View>

      <View style={{ marginBottom: 28, width: '100%', paddingHorizontal: 48, flexDirection: 'row', justifyContent: 'space-between', gap: 8 }}>
        <TouchableOpacity
          onPress={handleClose}
          className='flex-1 py-3 rounded-[20px] justify-center items-center bg-gray-700'
        >
